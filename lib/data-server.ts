...
export const getItems = (): InventoryItem[] => {
  const defaultItems: InventoryItem[] = [
    ...
    {
      item_id: 3,
      item_name: "Yamaha MT-07 Motorcycle",
      item_category: "Motorcycles",
      item_subcategory: "Street Bikes",
      item_condition: "refurbished",
      purchase_price: 720000,
      sale_price: 850000,
      quantity_in_stock: 2,
      purchase_date: "2024-01-05",
      profit_margin: 130000,
      description: "689cc parallel-twin motorcycle"
    },
    {
      item_id: 4,
      item_name: "Mountain Bike",
      item_category: "Bicycles",
      item_subcategory: "Mountain Bikes",
